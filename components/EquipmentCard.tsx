    ...
    <div className="bg-[#2A2A2A] rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-[#2A2A2A] hover:border-[#F2B705]/50">
      ...
      <div className="p-6">
        ...
        <button
          ...
          className="w-full bg-[#F2B705] hover:bg-[#E0A904] text-[#0E0E0E] font-semibold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
        >
          <svg
            className="w-5 h-5"
            fill="currentColor"
